...
<div class="container text-center">
  <div class="row mt-3">
    <div class="col">
      <p class="fs-2 fw-bold">Регистрация</p>
    </div>
  </div>
</div>
<div class="container">
  <div class="row mt-3">
    <div class="col">
        <div class="col-md-7 col-lg-8">
            <form method="post" action="verdon/sign_in.php">
            <div class="row g-3">
                <div class="col-sm-6">
                ...
                <label for="username" class="form-label">Username</label>
                    <div class="input-group has-validation">
                        ...
                        <input type="text" class="form-control" id="email" placeholder="Почта" name="email" required>
                        <div class="invalid-feedback">
                ...
                <div class="col-sm-6">
                <label for="lastName" class="form-label">Last name</label>
                <input type="text" class="form-control" id="pov_password" placeholder="Повторите пароль" name="pov_password" value="" required>
                    <div class="invalid-feedback">
                        Valid last name is required.
                    </div>
                </div>
    ...
    <div class="col">
        <img width="700" height="692"src="/resources/images/10.jpg" alt="map">
    </div>
  </div>
</div>
